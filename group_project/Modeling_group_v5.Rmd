...
CL.simu1 <- NaN*tset1; CL.simu1[1] <- 1
CD.simu1 <- NaN*tset1; CD.simu1[1] <- 1
CP.simu1 <- NaN*tset1; CP.simu1[1] <- 1
ME.simu1 <- NaN*tset1; ME.simu1[1] <- 1
MP.simu1 <- NaN*tset1; MP.simu1[1] <- 1
S.simu1 <- NaN*tset1; S.simu1[1] <- 0.5 #not sure what to put here
...
for(i in 2:length(tset1)){
  # calculate change in time
	...
	dME <- gm*ME*S + gammaM*S - ME*(h+dm)*dt #equation 4
