...
**Write answer here (please be concise!):**
...
# output values here as well as writing them below
```

**The vaccination proportion (p_crit) for the "black line" scenario 1 is: ____FILL IN HERE___**

**The vaccination proportion (p_crit) for the "blue line" scenario 2 is: ____FILL IN HERE___**

**The vaccination proportion (p_crit) for the "green line" scenario 3 is: ____FILL IN HERE___**
