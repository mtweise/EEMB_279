...
#first try
#i am going ot start with the population size at the end of the prey similuation, making the assumption that it reach 
#X04 <- X.simu1[length(tset)]
#P04 <- P.simu1[length(tset)]
