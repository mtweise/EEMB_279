...
# start new simulation with values from the end of the previous simulation
#set initial conditions to be the pop valus at equilibrium with hunting aka at the end of the simulation
X0_dis4b <- X.simu4a[length(tset3)]
P0_dis4b <- P.simu4a[length(tset3)]

head(X0_dis4b)
#SYNCHRONOUS
# creating holding vectors and storing initial conditions
X.simu6 <- NaN*tset3 #note tset2 and updated to simu3
X.simu6[1] <- X0_dis4b
P.simu6 <- NaN*tset3
P.simu6[1] <- P0_dis4b
...
#plot
# plot prey (X.simu3) against time (tset2)
plot(x = tset3, y = X.simu6,
     type = 'l', las = 1, lwd = 2, col = Xcol,
     xlab = 'Time', ylab = 'Density',
     ylim = c(0, 65))

# plot predator (P.simu3) against time (tset2)
lines(x = tset3, y = P.simu6,
      lwd = 2, col = Pcol)
