...
#is this simply asking for the same plot again??

####################################################
# 1. what are you plotting here? We are plotting our M.chameleon abundance observed over time
####################################################
plot(x = ExptDays, y = ln.MyDensities, #time along x axis and natural lof of abundance on the y axis
...
bargraph.CI(data = hempa_data, #
            ...
            main= "Hemiselmis pacifica", #adds figure title
            group = c(Treatment), # group by column of treatment
            xlab = 'Light Level', ylab = 'Estimated carrying capacity, K', #
           legend = TRUE, x.leg = 1, # legend specs
            bty = 'y', las = 1) # plot specification
 ...
 **Write answer in full sentences here: _________________**
