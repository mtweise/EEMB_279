...
# solver for dh/dt and dp/dt zngis
...
**Answer in text here, just state which one**

= /2 points total  

c. Why does (or does not) a faster partner dispersal rate accelerate invasion?  

**Answer in text here, please be concise!**
...
**Write answer and rationale for control agent selection, please be concise**
