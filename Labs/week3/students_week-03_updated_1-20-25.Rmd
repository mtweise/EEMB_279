...
# stable
points(y = Ystar, x = Nstar, # Plot a point at (Nstar, Ystar), representing a stable equilibrium
...
for(i in 1:length(Nset)) { 
  ...
  if(!is.na(dNdt.over[i]) && dNdt.over[i] == Y_MSY.over) { # Check if dNdt.over[i] is not NA AND equals Y_MSY.over
