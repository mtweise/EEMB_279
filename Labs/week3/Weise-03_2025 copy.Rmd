...
Last week, we talked about how to create bifurcation diagrams in lab. Remember that this is a figure where the stable equilibrium population size (N*) is plotted as a function of some parameter. In this case, let's make a bifurcation diagram for the logistic growth model of population growth, with stable equilibrium population size as a function of carrying capacity K.
...
Eset <- seq(from = 0, to = 10, length.out = 200)
```
...
plot(x = Nset, y = growth.dep, # Create a line plot with Nset on the x-axis and growth.dep on the y-axis
     ...
     xlab = 'N', # Label the x-axis as 'N'
     ylab = 'Change in Population') # Label the y-axis as 'Change in Population'
abline(h = 0)# Draw a horizontal line at y = 0 to represent equilibrium
...
I would be worried about being at the unstable equilibrium. I would avoid the problem byby extensively modeling and being aware that I am not at the maximum of our population growth curve.
...
K = 100
M = 10
growth.sub <-  r*N*(1-{N/K}) - q*E*N + M

dndt.sub <- r*N*(1-{N-K}) - q*E*N + M
...
plot(x = Nset, y = growth.sub, # Create a line plot with Nset on the x-axis and growth.sub on the y-axis
     type = 'l', # Use a line plot 
     lwd = 2,  # Set the line width to 2 for better visibility
     las = 1, # Rotate axis labels to be horizontal
     xlab = 'N', # Label the x-axis as 'N'
...
# 2. economics
############################
lines(x = Nset, y = q*E_MSY.sub*Nset,  # Add a line plot showing harvest as a function of Nset (Y = qEN)
      lwd = 2, # Set the line width to 2
      col = 'royalblue2') # Set the line color to royal blue
...
points(x = 0, y = 0, # Plot a point at (0, 0), representing a stable equilibrium
       ...
       cex = 1.5, # Set the size of the point to 1.5
       bg = 'black') # Fill the point with black to indicate stability
points(x = N_MSY.sub, y = Y_MSY.sub,   # Plot a point at (N_MSY.dep, Y_MSY.dep)
       pch = 21,  # Use the same point style
       cex = 1.5,# Set the size of the point to 1.5
       bg = 'black') # Fill the point with black to indicate stability

# unstable
points(x = N_star_unstable, y = Y.unstable.sub, # Plot a point at (N_star_unstable, Y.unstable.dep)
       pch = 21, # Use the same point style
       cex = 1.5,  # Set the size of the point to 1.5
       bg = 'white')  # Fill the point with white to indicate instability
